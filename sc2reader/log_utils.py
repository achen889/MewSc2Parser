...
def log_to_file(filename, level=DEFAULT_LOG_LEVEL, format=None, datefmt=None, **options):
    add_log_handler(logging.FileHandler(filename, **options), level, format, datefmt)


def log_to_console(level=DEFAULT_LOG_LEVEL, format=None, datefmt=None, **options):
    add_log_handler(logging.StreamHandler(**options), level, format, datefmt)


def add_log_handler(handler, level=DEFAULT_LOG_LEVEL, format=None, datefmt=None):
